...
struct i2c_pads_info i2c_pad_info2 = {
	.scl = {
		.i2c_mode = MX6_PAD_QSPI1B_DATA3__I2C2_SCL   | PC,
		.gpio_mode = MX6_PAD_QSPI1B_DATA3__GPIO4_IO_27 | PC,
		.gp = IMX_GPIO_NR(4, 27),
	},
	.sda = {
...
int dram_init(void)
{
//MP: era 	gd->ram_size = PHYS_SDRAM_SIZE;
...
static iomux_v3_cfg_t const fec_pre_reset_pads[] = {
    MX6_PAD_RGMII1_RXC__GPIO5_IO_5  | MUX_PAD_CTRL(NO_PAD_CTRL),
    MX6_PAD_RGMII2_RXC__GPIO5_IO_17 | MUX_PAD_CTRL(NO_PAD_CTRL),
};
...
static int setup_fec(int fec_id)
{
	...
	imx_iomux_v3_setup_multiple_pads(fec_pre_reset_pads,
		ARRAY_SIZE(fec_pre_reset_pads));
	...
	imx_iomux_v3_setup_multiple_pads(fec_post_reset_pads,
		ARRAY_SIZE(fec_post_reset_pads));
...
int checkboard(void)
{
	puts("Board: ENGICAM SmarCore M6SX\n");
